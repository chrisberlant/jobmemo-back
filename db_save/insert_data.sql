...
INSERT INTO "card" ("id", "title", "category", "index", "enterprise_name", "enterprise_activity", "contract_type", "description", "offer_url", "location", "salary", "job_title", "rating", "color", "is_deleted", "notes", "reminder", "logo_url", "created_at", "user_id") VALUES
